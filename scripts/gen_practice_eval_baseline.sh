...
# ====== Baseline Gen-Practice Eval ======
# Loads a HuggingFace model (not a local checkpoint) for generation.
# Default: free-gen mode (model chooses KC), NLL off.
...
echo "[Gen-Practice-Eval Baseline Config]"
